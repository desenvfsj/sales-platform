 ...
 * 
 * Nota: Esta entidade não é persistida em banco de dados,
 * os dados são carregados de um arquivo JSON mockado.
 */
public class Product {
    ...
    public Product(String id, String nome, String laboratorio, String grupo, 
