...
/**
 * Enum que define os tipos de problemas padronizados da API seguindo RFC 9457.
 * 
 * <p>Cada tipo de problema possui uma URI única que identifica o tipo de erro
 * e um título padrão legível por humanos.</p>
 * 
 * <p><strong>Referência:</strong> RFC 9457 - Problem Details for HTTP APIs</p>
 * 
