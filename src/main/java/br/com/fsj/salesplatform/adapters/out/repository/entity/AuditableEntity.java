 ...
 * 
 * <p>Esta classe utiliza {@link MappedSuperclass} para que seus campos sejam
 * herdados pelas entidades filhas sem criar uma tabela separada.</p>
 * 
 * <p><strong>Campos de Auditoria:</strong></p>
 * <ul>
 ...
 *   <li>{@code updatedBy} - Identificador do usuário que fez a última atualização</li>
 * </ul>
 * 
